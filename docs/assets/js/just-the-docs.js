...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/mplab_harmony_license.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#sdmmc-driver-asynchronous---sdmmc-read-write",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#setting-up-the-hardware"
  },"5": {
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the read data from the SD Card matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#running-the-application"
  },"6": {
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "SDMMC driver asynchronous - SDMMC Read Write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/sdmmc/async/sdmmc_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#spi-driver-asynchronous---self-loopback-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Use jumper wire to connect “Pin 21 of J15” to “Pin 19 of J15” . | SDI2 is mapped to RD7 that is routed to “Pin 21 of J15” | SDO2 is mapped to RG8 that is routed to “Pin 19 of J15” | . | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Use jumper wire to connect “Pin 21 of J15” to “Pin 19 of J15” . | SDI2 is mapped to RD7 that is routed to “Pin 21 of J15” | SDO2 is mapped to RG8 that is routed to “Pin 19 of J15” | . | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware"
  },"11": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#running-the-application"
  },"12": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "SPI Driver asynchronous - Self loopback multi client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#spi-driver-synchronous---self-loopback-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#description",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#description"
  },"15": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/spi/sync/spi_self_loopback_multi_client/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mz_dag_sk_freertos.X | MPLABX project for PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk_freertos.X | MPLABX project for PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk_freertos.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk_freertos.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Use jumper wire to connect “Pin 21 of J15” to “Pin 19 of J15” . | SDI2 is mapped to RD7 that is routed to “Pin 21 of J15” | SDO2 is mapped to RG8 that is routed to “Pin 19 of J15” | . | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Use jumper wire to connect “Pin 21 of J15” to “Pin 19 of J15” . | SDI2 is mapped to RD7 that is routed to “Pin 21 of J15” | SDO2 is mapped to RG8 that is routed to “Pin 19 of J15” | . | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#running-the-application"
  },"18": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "SPI Driver synchronous - Self loopback multi client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/async/usart_echo/readme.html#usart-driver-asynchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/async/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/async/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#running-the-application"
  },"24": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "USART driver asynchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/async/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/sync/usart_echo/readme.html#usart-driver-synchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/sync/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application"
  },"28": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk_freertos.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk_freertos.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect a micro USB cable to the USART-USB port J5 | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect a micro USB cable to the USART-USB port J5 | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware"
  },"29": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/sync/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#running-the-application"
  },"30": {
    "doc": "USART driver synchronous - USART echo",
    "title": "USART driver synchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/driver/usart/sync/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_fat/readme.html#fat-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/nvm_fat/readme.html#setting-up-the-hardware"
  },"35": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON when the File FILE.TXT has the app data “Hello World” written in it | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | SW1 | LED3 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | SW1 | LED3 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#running-the-application"
  },"36": {
    "doc": "FAT filesystem using NVM Media",
    "title": "FAT filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_mpfs/readme.html#mpfs-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_mpfs/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_mpfs/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/nvm_mpfs/readme.html#downloading-and-building-the-application"
  },"40": {
    "doc": "MPFS filesystem using NVM Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_mpfs/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/nvm_mpfs/readme.html#setting-up-the-hardware"
  },"41": {
    "doc": "MPFS filesystem using NVM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the following criteria is satisfied . | File “FILE.txt” has the string “Hello World” in it | File “TEST.txt” has the string “1234567890” in it | . | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED3 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_mpfs/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_mpfs/readme.html#running-the-application"
  },"42": {
    "doc": "MPFS filesystem using NVM Media",
    "title": "MPFS filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_mpfs/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_sqi_fat/readme.html#fat-filesystem-using-nvm-and-sst26-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_sqi_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_sqi_fat/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_sqi_fat/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_sqi_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_sqi_fat/readme.html#running-the-application"
  },"48": {
    "doc": "FAT filesystem using NVM and SST26 Media",
    "title": "FAT filesystem using NVM and SST26 Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/nvm_sqi_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/sdmmc_fat/readme.html#fat-filesystem-using-sdmmc-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/apps/fs/sdmmc_fat/readme.html#description",
    ...
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 17 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 9 | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 2 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.3.0 | . | MPLAB® XC32 C/C++ Compiler v4.21 | . ",
    "url": "http://localhost:4000/core_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v340",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v330",
    ...
    "url": "http://localhost:4000/core_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v320",
...
var repo_name = "core_apps_pic32mz_da";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for PIC32MZ DA family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_pic32mz_da/assets/css/just-the-docs-' + theme + '.css');
}
